                    ...
                    <div class="card-body">
                        ...
                        @csrf
                            <div class="table-responsive">
                                <table class="table new-table data-table-export" id="newTable" data-export-title="Services" data-export-filename="Services">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offFilter" aria-labelledby="offFiltertLabel">
    ...
    <a href="{{ url('services') }}" class="btn btn-danger">Clear</a>
</form>
