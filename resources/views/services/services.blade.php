                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a href="{{ url('create-service') }}">
                            <button class="create-btn">
                                ...
                                <span class="button-text">{{ __('app.services.create-title') }}</span>
                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                                ...
                                <div>
                                    @if (in_array(strtolower('export-services'), array_map('strtolower', $permissions)))
                                            ...
                                            <div>
                                                ...
                                                <form action="" method="get" enctype="multipart/form-data">
                                                    ...
                                                    <div class="d-flex justify-content-center gap-3 align-items-center">
                                                        ...
                                                        <a href="{{ url('services') }}" class="btn clear-all-btn">Clear</a>
                                                    </div>
                            ...
                            <div class="row g-4">
                                <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-services') }}">
                                    @csrf
                                    <div class="table-responsive">
                                        <table class="table new-table data-table-export" id="newTable"
                                            data-export-title="Services" data-export-filename="Services">
                                   ...
                                   ?>
                                                <tr class="odd gradeX">
                                                    <td><input type="checkbox" name="selected_services[]"
                                                            value="{{ $service->id }}"></td>
