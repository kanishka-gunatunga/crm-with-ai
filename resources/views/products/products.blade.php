                    ...
                    <div class="d-flex gap-3">
                        ...
                        {{-- <a href="#">
                            <button class="import-leads-button">
                                ...
                                <span class="button-text white-btn-text">Import Products</span>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div>
                                                ...
                                                <form action="" method="get" enctype="multipart/form-data">
                                                    ...
                                                    <a href="{{ url('products') }}" class="btn clear-all-btn">Clear</a>
                                                </div>
                                                </form>
                                            </div>
                                        </div>
                            ...
                            <div class="row g-4">
                                <form id="bulk-delete-form" method="POST"
                                    action="{{ url('delete-selected-products') }}">
                                    @csrf
                                    <div class="table-responsive">
                                        <table class="table new-table data-table-export" id="newTable"
                                            data-export-title="Products" data-export-filename="Products">
