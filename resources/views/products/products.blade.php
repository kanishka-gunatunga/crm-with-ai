                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table new-table data-table-export" id="newTable"  data-export-title="Products" data-export-filename="Products">
                                            ...
                                            <button type="submit" class="btn btn-danger btn-xs mb-2" onclick="return confirm('Are you sure you want to delete selected records?')">Delete Selected</button>
                                            </form>               
                                        </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offFilter" aria-labelledby="offFiltertLabel">
    ...
    <a href="{{ url('products') }}" class="btn btn-danger btn-sm">Clear</a>
</form>
