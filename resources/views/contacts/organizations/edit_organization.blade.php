...
<div class="main-scrollable">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">{{ __('app.contacts.organizations.title') }}</a></li>
                            <li class="breadcrumb-item active current-breadcrumb" aria-current="page"> {{ __('app.contacts.organizations.edit-title') }}</li>
                        </ol>
                    </nav>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row g-4">
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="field1" placeholder="Name"  name="name" value="{{ $organization->name }}" required>
                                </div>
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="field4" placeholder="Address" name="address" value="{{ $organization->address }}">
                                </div>
                                <div class="col-12 col-md-4">
                                    <label for="field3" class="form-label">Country</label>
                                    <select class="myDropdown form-control" name="country">
                                        <option value="{{ $organization->country }}" selected="" hidden>{{ $organization->country }}</option>
                                        <option value="Sri Lanka">Sri Lanka</option>
                                    </select>
                                </div>
                                 <div class="col-12 col-md-4">
                                    <label for="field3" class="form-label">State</label>
                                    <input type="text" class="form-control" name="city" placeholder="City"  name="state" value="{{ $organization->state }}">
                                </div>

                                <div class="col-12 col-md-4">

                                    <label for="field4" class="form-label">City</label>
                                    <input type="text" class="form-control" id="field4" placeholder="City" name="city" value="{{ $organization->city }}">
                                </div>

                                <div class="col-12 col-md-4">

                                    <label for="field4" class="form-label">Postal Code</label>
                                    <input type="text" class="form-control" id="field4" placeholder="Postal Code" name="post_code" value="{{ $organization->post_code }}">
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="d-flex align-items-center">
                                        <label for="field4" class="form-label">Emails</label>
                                        <div class="ms-3 mb-2">
                                            <button class="btn add-more-button p-0 mx-1" id="add-emails" onclick="addEmailField()" type="button">
    ...
    <div class="d-flex gap-2 justify-content-between">
        ...
        <div>
            ...
            <a href="{{url('organizations')}}"><button type="button" class="btn cancel-btn">Cancel</button></a>
        </div>
