                            ...
                            <div class="card-body">
                                ...
                                <div class="card card-default">
                                    <div class="card-body">
                                        ...
                                        <div class="row g-4">
                                            <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-organizations') }}">
                                            @csrf
                                            <div class="table-responsive">
                                                <table class="table new-table data-table-export" data-export-title="Organizations" data-export-filename="Organizations">
                                                    ...
                                                    <thead>
                                                     ...
                                                     <tbody>
                                                        ...
                                                        $person_count = Person::where('organization',$organization->id)->count();
                                                            ?>
                                                                    <tr class="odd gradeX">
                                                                        <td><input type="checkbox" name="selected_organizations[]" value="{{ $organization->id }}"></td>
                                                                        <td class="">{{$organization->id}} </td>
                                                                        <td class="">{{$organization->name}} </td>
                                                                    
                                                                        <td class=""><a href="{{url('persons?organization='.$organization->id)}}">{{number_format($person_count)}}</a></td>
    ...
    <form action="" method="get" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" class="form-control" name="id" value="{{ old('id', request('id')) }}">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" class="form-control" name="created_start_date" value="{{ old('created_start_date', request('created_start_date')) }}">
                </div>

                <div class="col-md-6 mb-3">
                    <label for="created_end_date" class="form-label">Create End</label>
                    <input type="date" class="form-control" name="created_end_date" value="{{ old('created_end_date', request('created_end_date')) }}">
                </div>
               
            </div>

            <button type="submit" class="btn btn-info">Apply Filter</button>
            <a href="{{ url('organizations') }}" class="btn btn-danger">Clear</a>
        </form>
...
<div class="modal fade importOrganizations" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
        <form method="POST" action="{{ url('import-organizations') }}" enctype="multipart/form-data" data-parsley-validate>
                @csrf
        ...
        <div class="col-md-12">
            <div class="mb-3">
                ...
                <input type="file" class="form-control" name="organizations" value="" required>
                @if($errors->has("organizations")) <div class="alert alert-danger mt-2">{{ $errors->first('organizations') }}</li></div>@endif
                <a href="{{ asset('uploads/import_templates/Organizations Import Template.xlsx') }}" download>Download Template</a>
            </div>
        </div>
