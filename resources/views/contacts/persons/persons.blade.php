...
@section('content')
                                ...
                                <div class="card-body">
                                                        ...
                                                        <form action="" method="get" enctype="multipart/form-data">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="email"
                                                                        value="{{ request('email', $filters['email'] ?? '') }}">
                                                                </div>
                                                                ...
                                                                <div class="col-md-12 mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="contact_number"
                                                                        value="{{ request('contact_number', $filters['contact_number'] ?? '') }}">
                                                                </div>
                                                                    ...
                                                                    <select class="form-control" name="organization">
                                                                        ...
                                                                        @foreach ($organizations as $organization)
                                                                            <option value="{{ $organization->id }}"
                                                                                {{ request('organization', $filters['organization'] ?? '') == $organization->id ? 'selected' : '' }}>
                                                                                {{ $organization->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                    ...
                                    <div class="row g-4">
                                        <form id="bulk-delete-form" method="POST"
                                            action="{{ url('delete-selected-persons') }}">
                                            @csrf
                                            <div class="table-responsive">
                                                <table class="table new-table data-table-export"
                                                    data-export-title="Persons" data-export-filename="Persons">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <tr class="odd gradeX">
                                                            <td><input type="checkbox" name="selected_persons[]"
                                                                    value="{{ $person->id }}"></td>
                                                            ...
                                                            <td class="">
                                                                @if ($person->emails)
                                                                    @php
                                                                        $emails = is_string($person->emails)
    ...
    <div class="modal fade importPersons" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        <div class="modal-dialog modal-md">
            <form method="POST" action="{{ url('import-persons') }}" enctype="multipart/form-data"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="firstNameinput" class="form-label">Select File (CSV,
                                        Excel)</label>
                                    <input type="file" class="form-control" name="persons" value="" required>
                                    @if ($errors->has('persons'))
                                        <div class="alert alert-danger mt-2">{{ $errors->first('persons') }}</li>
                                        </div>
                                    @endif
                                    <a href="{{ asset('uploads/import_templates/Persons Import Template.xlsx') }}"
