...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        button.addEventListener('click', function() {
            ...
            if (!dtButtonsContainer || !dtButtonsContainer.classList.contains('dt-buttons')) {
                 const commonAncestor = this.closest('.page-container, .main-scrollable, .table-controls-area'); // Add your relevant parent classes/IDs here
                 if (commonAncestor) {
            ...
            if (dtButtonsContainer && dtButtonsContainer.classList.contains('dt-buttons')) {
                dtButtonsContainer.classList.toggle('d-none'); // Use a CSS class to toggle visibility
            } else {
                console.warn("Could not find a corresponding '.dt-buttons' container for the clicked export toggle button.", this);
            }
        });
    });
