            ...
            <div class="page-title-container">
                <div class="d-flex justify-content-between">
                    ...
                    <!-- <div class="d-flex gap-3">
                                <button class="import-configurations-button">
                                    ...
                                    <span class="button-text">Import configurations</span>
                                </button>
                                ...
                                <button class="import-configurations-button">
                                    ...
                                    <span class="button-text">Export configurations</span>
                                </button>




                                <a href="../configurations/create-configuration.php">
                                    <button class="import-configurations-button">
                                        <div class="icon-container">
                                            <svg
                                                width="15"
                                        ...
                                        <span class="button-text">New configuration</span>
                            ...
                            <form action="{{ route('lang.switch', app()->getLocale()) }}" method="GET" class="d-inline">
                                ...
                                <select onchange="location = this.value;" class="form-select">
                                    ...
                                    <option value="{{ route('lang.switch', 'fa') }}"
                                        {{ app()->getLocale() == 'fa' ? 'selected' : '' }}>فارسی</option>
                                    <option value="{{ route('lang.switch', 'tr') }}"
                                        {{ app()->getLocale() == 'tr' ? 'selected' : '' }}>Turkçe</option>
                                    <option value="{{ route('lang.switch', 'ar') }}"
                                        {{ app()->getLocale() == 'ar' ? 'selected' : '' }}>Arabic</option>
                                    <option value="{{ route('lang.switch', 'es') }}"
                                        {{ app()->getLocale() == 'es' ? 'selected' : '' }}>Spanish</option>
                                </select>
                            </form>

                            <div style="width:250px;" class="mb-4">
                                <img src="{{ asset('uploads/' . $config->logo) }}" class="img-fluid" id="company-logo"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="company_logo" id="company_logo" class="form-control"
                                        onchange="previewAndUploadImage(this)" required>
                                </div>
                            </div>
                        </div>
