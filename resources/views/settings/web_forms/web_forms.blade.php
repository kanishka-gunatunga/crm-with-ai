                        ...
                        <div class="card-body">
                                            ...
                                            <div>
                                                ...
                                                <form action="" method="get" enctype="multipart/form-data">
                                                    ...
                                                    <div class="d-flex justify-content-center gap-3 align-items-center">
                                                        ...
                                                        <a href="{{ url('web-forms') }}" class="btn clear-all-btn">Clear</a>
                                                    </div>
                            ...
                            <div class="row g-4">
                                <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-webforms') }}">
                                   ...
                                   ?>
                                                <tr class="odd gradeX">
                                                    <td><input type="checkbox" name="selected_webforms[]"
                                                            value="{{ $form->id }}"></td>
                                                    <td class="">{{ $form->id }} </td>
                                                    <td class="">{{ $form->title }} </td>

                                                    <td class="action-icons d-flex gx-3">
                                                        <a href="{{ url('delete-web-form/' . $form->id) }}"
                                                        ...
                                                        <a target="_blank"
                                                            href="{{ url('view-web-form/' . $form->uid) }}">
                                                            <div class="text-muted" type="button">
