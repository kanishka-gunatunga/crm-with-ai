                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="{{url('create-web-form')}}">
                        <button class="import-leads-button">
                            ...
                            <span class="button-text">Web form</span>
                ...
                <div class="card card-default">
                    <div class="card-body">
                        <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                            <div>
                                <h3 class="card-title">Web forms</h3>
                            </div>
                            <div>
                        ...
                        <div class="row g-4">
                            <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-webforms') }}">
                            @csrf
                            <div class="table-responsive">
                                <table class="table new-table data-table-export" data-export-title="Users" data-export-filename="Users">
                                   ...
                                   ?>
                                        <tr class="odd gradeX">
                                            <td><input type="checkbox" name="selected_webforms[]" value="{{ $form->id }}"></td>
                                            <td class="">{{$form->id}} </td>
                                            <td class="">{{$form->title}} </td>
     
                                            <td class="action-icons d-flex gx-3">
                                                <a href="{{ url('delete-web-form/'.$form->id) }}" class="delete-link-confirm">
                                                ...
                                                <a href="{{ url('edit-web-form/'.$form->id) }}">
                                                    <div class="text-muted" type="button">
                                                        <svg width="20" height="20" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                               ...
                                               <a target="_blank" href="{{ url('view-web-form/'.$form->uid) }}">
                                                    <div class="text-muted" type="button">
                                                       <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
<rect width="18" height="18" rx="2.90323" fill="#DAFFE1"/>
<path d="M9.06445 6.43457C11.8438 6.43457 13.127 9.0002 13.127 9.0002C13.127 9.0002 11.8438 11.5658 9.06445 11.5658C6.28508 11.5658 5.00195 9.0002 5.00195 9.0002C5.00195 9.0002 6.28508 6.43457 9.06445 6.43457Z" stroke="#0AC900" stroke-width="0.580625" stroke-linejoin="round"/>
<path d="M10.277 9C10.2808 9.16646 10.2512 9.33199 10.1901 9.48687C10.1289 9.64175 10.0375 9.78285 9.92105 9.9019C9.80464 10.0209 9.66562 10.1155 9.51215 10.1801C9.35868 10.2447 9.19385 10.2779 9.02734 10.2779C8.86084 10.2779 8.69601 10.2447 8.54254 10.1801C8.38907 10.1155 8.25005 10.0209 8.13363 9.9019C8.01722 9.78285 7.92576 9.64175 7.86463 9.48687C7.8035 9.33199 7.77393 9.16646 7.77766 9C7.77766 8.66848 7.90935 8.35054 8.14377 8.11612C8.37819 7.8817 8.69614 7.75 9.02766 7.75C9.35918 7.75 9.67712 7.8817 9.91154 8.11612C10.146 8.35054 10.2777 8.66848 10.2777 9H10.277Z" stroke="#0AC900" stroke-width="0.580625" stroke-linejoin="round"/>
</svg>
                                                    </div>
                                                </a>
                                            </td>
 ...
 <script>
    ...
    document.getElementById('select-all').addEventListener('click', function(event) {
        let checkboxes = document.querySelectorAll('input[name="selected_webforms[]"]');
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offFilter" aria-labelledby="offFiltertLabel">
    ...
    <a href="{{ url('web-forms') }}" class="btn btn-danger">Clear</a>
</form>
