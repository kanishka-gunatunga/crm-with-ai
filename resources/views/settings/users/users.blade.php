                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="{{url('create-user')}}">
                        <button class="import-leads-button">
                            ...
                            <span class="button-text">{{ __('app.settings.users.create-title') }}</span>
                ...
                <div class="card card-default">
                    <div class="card-body">
                        <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                            <div>
                                <h3 class="card-title">{{ __('app.settings.users.title') }}</h3>
                            </div>
                            <div>
                                ...
                                <table class="table new-table data-table-export" data-export-title="Users" data-export-filename="Users">
                                   ...
                                   ?>
                                        ...
                                        <td><input type="checkbox" name="selected_users[]" value="{{ $user->id }}"></td>
                                            <td class="">{{$user->id}} </td>
                                            <td class="">{{$user->userDetails->name}} </td>
                                            ...
                                            <td class="">{{$user->created_at}}</td>
                                             <td class="action-icons d-flex gx-3">
                                                <a href="{{ url('delete-user/'.$user->id) }}" class="delete-link-confirm">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offFilter" aria-labelledby="offFiltertLabel">
    ...
    <div class="row">
        ...
        <div class="col-md-12 mb-3">
            <label for="person" class="form-label">Status</label>
    ...
    <a href="{{ url('users') }}" class="btn btn-danger">Clear</a>
</form>
