                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="table-responsive">
                                <table class="table new-table data-table-export" data-export-title="Pipelines" data-export-filename="Pipelines">
                                   ...
                                   ?>
                                        <tr class="odd gradeX">
                                            <td><input type="checkbox" name="selected_pipelines[]" value="{{ $pipeline->id }}"></td>
                                            ...
                                            <td class="">{{$pipeline->is_default}} </td>
                                             ...
                                             <td class="action-icons d-flex gx-3">
                                                ...
                                                <a href="{{ url('delete-pipeline/'.$pipeline->id) }}" class="delete-link-confirm">
