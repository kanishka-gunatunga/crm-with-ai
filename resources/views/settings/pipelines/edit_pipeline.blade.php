...
<div class="main-scrollable">
    <div class="page-container">
                ...
                <div class="card card-default mb-4">
                    ...
                    <div class="card-body">
                        <table class="table table-nowrap mt-4">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td ><input type="text" class="form-control" name="stages[]" value="New" readonly required></td>
                                                   ...
                                                   <?php foreach($pipeline->stages as $stage){ 
                                                    ...
                                                    <tr>
                                                        <td ><input type="text" class="form-control" name="stages[]" value="Lost" readonly required></td>
                                                        <td><input type="number" step="any" class="form-control" name="probabilities[]" value="0" readonly required></td>
                                                        <td></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            <button type="button" class="btn add-more-button mx-1 p-0" id="add_stage">
                                                <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                 ...
                                                 <span class="lg-button-text">{{ __('app.settings.pipelines.add-stage-btn-title') }}</span>
                                            </button>
       ...
       <div class="col-12 action-bar">
                        ...
                        <div>
                            <button type="submit" class="btn save-btn">Save</button>
                             <a href="{{url('pipelines')}}"><button type="button" class="btn cancel-btn">Cancel</button></a>
                        </div>
