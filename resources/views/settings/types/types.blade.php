                        ...
                        <div class="card-body">
                            <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    @if (in_array(strtolower('export-types'), array_map('strtolower', $permissions)))
                            ...
                            <div class="row g-4">
                                <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-types') }}">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table new-table data-table-export" data-export-title="Types"
                                            data-export-filename="Types">
                                   ...
                                   ?>
                                                <tr class="odd gradeX">
                                                    <td><input type="checkbox" name="selected_types[]"
                                                            value="{{ $type->id }}"></td>
                                                    <td class="">{{ $type->id }} </td>
