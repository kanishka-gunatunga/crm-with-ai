                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                                ...
                                <div>
                                    @if (in_array(strtolower('export-roles'), array_map('strtolower', $permissions)))
                                            ...
                                            <div>
                                                ...
                                                <form action="" method="get" enctype="multipart/form-data">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <select class="form-control" name="permission_type">
                                                                ...
                                                                <option value="all"
                                                                    {{ request('permission_type') == 'all' ? 'selected' : '' }}>
                                                                    All
                                                                </option>
                                                                <option value="custom"
                                                                    {{ request('permission_type') == 'custom' ? 'selected' : '' }}>
                                                                    Custom
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-center gap-3 align-items-center">
                                                        ...
                                                        <a href="{{ url('roles') }}" class="btn clear-all-btn">Clear</a>
                                                    </div>
