                                            ...
                                            <div>
                                                ...
                                                <form action="" method="get" enctype="multipart/form-data">
                                                    ...
                                                    <div class="d-flex justify-content-center gap-3 align-items-center">
                                                        ...
                                                        <a href="{{ url('groups') }}" class="btn clear-all-btn">Clear</a>
                                                    </div>
                            ...
                            <div class="row g-4">
                                <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-groups') }}">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table new-table data-table-export" data-export-title="Groups"
                                            data-export-filename="Groups">
                                        ...
                                        ?>
                                                <tr class="odd gradeX">
                                                    <td><input type="checkbox" name="selected_groups[]"
                                                            value="{{ $group->id }}"></td>
