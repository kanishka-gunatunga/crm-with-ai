...
<div class="main-scrollable">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="{{url('create-group')}}">
                        <button class="import-leads-button">
                            ...
                            <span class="button-text">{{ __('app.settings.groups.create-title') }}</span>
                ...
                <div class="card card-default">
                    <div class="card-body">
                        <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                            <div>
                                <h3 class="card-title">{{ __('app.settings.groups.title') }}</h3>
                            </div>
                            <div>
                        ...
                        <div class="row g-4">
                            <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-groups') }}">
                            @csrf
                            <div class="table-responsive">
                                <table class="table new-table data-table-export" data-export-title="Groups" data-export-filename="Groups">
                                    ...
                                    <tbody>
                                       <?php foreach($groups as $group){
                                        ?>
                                                <tr class="odd gradeX">
                                                    <td><input type="checkbox" name="selected_groups[]" value="{{ $group->id }}"></td>
                                                    ...
                                                    <td class="">{{$group->description}} </td>
                                                     ...
                                                     <td class="action-icons d-flex gx-3">
                                                        ...
                                                        <a href="{{ url('delete-group/'.$group->id) }}" class="delete-link-confirm">
 ...
 <script>
    ...
    document.getElementById('select-all').addEventListener('click', function(event) {
        let checkboxes = document.querySelectorAll('input[name="selected_groups[]"]');
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offFilter" aria-labelledby="offFiltertLabel">
    ...
    <a href="{{ url('groups') }}" class="btn btn-danger">Clear</a>
</form>
