    ...
    <div class="page-container">
        ...
        <div class="page-title-container mb-0">
            <div class="d-flex justify-content-between">
                <div>
                    <h3 class="page-title">
                        {{ __('app.settings.groups.edit-title') }}
                    </h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Settings</a></li>
                            <li class="breadcrumb-item"><a href="#"> {{ __('app.settings.groups.title') }}</a></li>
                            <li class="breadcrumb-item active current-breadcrumb" aria-current="page">{{ __('app.settings.groups.edit-title') }}</li>
                        </ol>
                    </nav>
                </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row g-4">
                                <div class="col-12 col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="field1" placeholder="Name" name="name" value="{{ $group->name }}" required>
                                </div>
