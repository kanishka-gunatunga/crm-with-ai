                                        ...
                                        <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                                            ...
                                            <div class="d-md-flex d-block gap-1">
                                                <div class="nav nav-tabs gap-1 border-0" id="nav-tab" role="tablist">
                                                    <button class="btn white-btn tab-button active" id="nav-all-tab" data-bs-toggle="tab" data-bs-target="#nav-all" type="button" role="tab" aria-controls="nav-all" aria-selected="true">
                                                    ...
                                                    <button class="btn white-btn tab-button " id="nav-leads-tab" data-bs-toggle="tab" data-bs-target="#nav-leads" type="button" role="tab" aria-controls="nav-leads" aria-selected="false">
                                                    ...
                                                    <button class="btn white-btn tab-button " id="nav-persons-tab" data-bs-toggle="tab" data-bs-target="#nav-persons" type="button" role="tab" aria-controls="nav-persons" aria-selected="false">
                                                    ...
                                                    <button class="btn white-btn tab-button " id="nav-organizations-tab" data-bs-toggle="tab" data-bs-target="#nav-organizations" type="button" role="tab" aria-controls="nav-organizations" aria-selected="false">
                                                        <svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <button class="btn white-btn tab-button " id="nav-products-tab" data-bs-toggle="tab" data-bs-target="#nav-products" type="button" role="tab" aria-controls="nav-products" aria-selected="false">
                                                        <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M6.5 6.34766V12.4351L6.09375 12.6382L0.8125 10.0039V3.40234L6.09375 0.761719L11.375 3.40234V8.125H10.5625V4.31641L6.5 6.34766ZM6.09375 1.67578L4.56396 2.4375L8.50586 4.43066L10.061 3.65625L6.09375 1.67578ZM5.6875 11.5273V6.34766L1.625 4.31641V9.49609L5.6875 11.5273ZM2.12646 3.65625L6.09375 5.63672L7.60449 4.8877L3.65625 2.89453L2.12646 3.65625ZM8.9375 11.375V10.5625H13V11.375H8.9375ZM8.9375 8.9375H13V9.75H8.9375V8.9375ZM7.3125 13V12.1875H8.125V13H7.3125ZM7.3125 9.75V8.9375H8.125V9.75H7.3125ZM7.3125 11.375V10.5625H8.125V11.375H7.3125ZM8.9375 13V12.1875H13V13H8.9375Z" fill="#172635" />
                                                        </svg>
