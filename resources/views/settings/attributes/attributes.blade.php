                            ...
                            <div class="d-flex gap-3 mb-4 justify-content-between align-items-center">
                                ...
                                <div class="d-md-flex d-block gap-1">
                                    <div class="nav nav-tabs gap-1 border-0" id="nav-tab" role="tablist">
                                        ...
                                        <button class="btn white-btn tab-button " id="nav-leads-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-leads" type="button" role="tab"
                                            aria-controls="nav-leads" aria-selected="false">
                                        ...
                                        <button class="btn white-btn tab-button " id="nav-persons-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-persons" type="button" role="tab"
                                            aria-controls="nav-persons" aria-selected="false">
                                        ...
                                        <button class="btn white-btn tab-button " id="nav-quotes-tab" data-bs-toggle="tab"
                                            data-bs-target="#nav-quotes" type="button" role="tab"
                                            aria-controls="nav-quotes" aria-selected="false">
                                            <svg width="13" height="13" viewBox="0 0 13 13" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
