                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active current-breadcrumb" aria-current="page">
                                                {{ __('app.settings.attributes.edit-title') }}</li>
                                        </ol>
                                    </nav>
                                </div>
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="field1" placeholder="Code"
                                                    name="code" value="{{ $attribute->code }}" readonly>
                                                @if ($errors->has('code'))
                                        ...
                                        <div class="row g-4 mt-1">
                                                ...
                                                <div id="multi-options" class="mt-3" style="display:none;">
                                                    <div class="mb-3" id="option-types">
                                                        ...
                                                        <select class=" form-select" name="option_type" id="option_type">
                                                            <option selected hidden value="{{ $attribute->option_type }}">
                                                                {{ $attribute->option_type }}</option>
                                                    ...
                                                    <div class="mb-3" id="lookups">
                                                        ...
                                                        <select class=" form-select" name="lookup_type" id="lookup_type">
                                                            <option selected hidden value="{{ $attribute->lookup_type }}">
                                                                {{ $attribute->lookup_type }}</option>
                                                        ...
                                                        foreach($attribute->options as $attributeOption){ ?>
                                                            <div class="row mb-2">
                                                                <div class="col-md-10"><input type="text"
                                                                        ...
                                                                        value="{{ $attributeOption }}" required></div>
                                                                <div class="col-md-2"><i
                                                                        class="fa-solid fa-trash delete-stage remove-append-item mx-2 remove-option"></i>
                                                                </div>
                                                            </div>
                                                            <?php }} ?>
                                                        </div>
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <select class="myDropdown form-control" name="is_required">
                                                    <option selected hidden value="{{ $attribute->is_required }}">
                                                        {{ $attribute->is_required }}</option>
                                            ...
                                            <div class="col-12 col-md-4">
                                                ...
                                                <select class="myDropdown form-select" name="is_unique">
                                                    <option selected hidden value="{{ $attribute->is_unique }}">
                                                        {{ $attribute->is_unique }}</option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                                </select>
                                            ...
                                            <div class="col-12 col-md-4" id="validation-col" style="display:none;">
                                                ...
                                                <select class=" form-select" name="input_validation">
                                                    <option selected hidden value="{{ $attribute->input_validation }}">
                                                        {{ $attribute->input_validation }}</option>
