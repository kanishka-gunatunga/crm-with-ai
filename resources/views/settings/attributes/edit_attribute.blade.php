                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    @if($errors->has("entity_type")) <div class="alert alert-danger mt-2">{{ $errors->first('entity_type') }}</li></div>@endif
                                                </div>
                                            ...
                                            <div class="row g-4 mt-1">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    @if($errors->has("type")) <div class="alert alert-danger mt-2">{{ $errors->first('type') }}</li></div>@endif
                                                    ...
                                                    <div class="mb-3" id="lookups">
                                                        ...
                                                        <select class=" form-select" name="lookup_type" id="lookup_type">
                                                            ...
                                                            <option value="lead_pipeline_stages">Lead Pipeline Stages</option>
                                                    ...
                                                    <div class="mb-3" id="options-container" style="display:none;">
                                                        <label class="form-label d-block">{{ __('app.settings.attributes.options') }}</label>
                                                        <button type="button" class="btn add-more-button mx-1 p-0" id="add-option">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    @if($errors->has("is_required")) <div class="alert alert-danger mt-2">{{ $errors->first('is_required') }}</li></div>@endif
                                                </div>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    ...
                                                    <select class="myDropdown form-select" name="is_unique" >
                                                     ...
                                                     @if($errors->has("is_unique")) <div class="alert alert-danger mt-2">{{ $errors->first('is_unique') }}</li></div>@endif
                                                </div>
                                                ...
                                                <div class="col-12 col-md-4" id="validation-col" style="display:none;">
                                                    ...
                                                    <select class=" form-select" name="input_validation"  >
                                                     ...
                                                     @if($errors->has("input_validation")) <div class="alert alert-danger mt-2">{{ $errors->first('input_validation') }}</li></div>@endif
                                                </div>
...
<div class="col-12 action-bar">
                        ...
                        <div>
                            <button type="submit" class="btn save-btn">Save</button>
                             <a href="{{url('attributes')}}"><button type="button" class="btn cancel-btn">Cancel</button></a>
                        </div>
...
<script>
    ...
    else if (selectedType === 'select' || selectedType === 'multiselect' || selectedType === 'checkbox') {
        $('#multi-options').show();
        $('#option-types').show();
        $('#lookups').show();
    }
