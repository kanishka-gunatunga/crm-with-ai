                                                ...
                                                <form action="" method="get" enctype="multipart/form-data">
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label for="sku"
                                                                class="form-label">{{ __('app.datagrid.id') }}</label>
                                                            <input type="text" class="form-control" name="id"
                                                                value="{{ request('id') }}">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label for="name"
                                                                class="form-label">{{ __('app.datagrid.name') }}</label>
                                                            <input type="text" class="form-control" name="name"
                                                                value="{{ request('name') }}">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                            <label for="name"
                                                                class="form-label">{{ __('app.datagrid.subject') }}</label>
                            ...
                            <div class="row g-4">
                                <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-templates') }}">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table new-table data-table-export" data-export-title="Email Templates"
                                            data-export-filename="Email Templates">
                                   ...
                                   ?>
                                                <tr class="odd gradeX">
                                                    <td><input type="checkbox" name="selected_templates[]"
                                                            value="{{ $template->id }}"></td>
                                                    <td class="">{{ $template->id }} </td>
                                                    <td class="">{{ $template->name }} </td>
                                                    <td class="">{{ $template->subject }} </td>
                                                    <td class="action-icons d-flex gx-3">
                                                        <a href="{{ url('delete-email-template/' . $template->id) }}"
