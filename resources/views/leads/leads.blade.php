                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <button class="import-leads-button" data-bs-toggle="modal" data-bs-target=".exportTypes">
                            ...
                            <span class="button-text">{{ __('app.leads.export-leads') }}</span>
                        </button>
                                    ...
                                    <article class="notification-card">
                                        <div class="notification-content new w-100">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <span class="notification-badge" id="stage-value-{{ $stage->id }}"> ${{ number_format($stage_value) }}</span>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12 text-center">
                            <div class="mb-3">
                                <a href="{{ url('export-leads/excel') }}"><button type="button"
                                        class="btn btn-info">Excel</button></a>
                                <a href="{{ url('export-leads/csv') }}"><button type="button"
                                        class="btn btn-info">CSV</button></a>
                            </div>
                        </div>
