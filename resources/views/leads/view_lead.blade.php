...
@section('content')
                    ...
                    <div class="card card-default mb-4">
                        <div class="card-body col-12">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                            <section class="primary-info">
                                                ...
                                                <div class="terms-section">
                                                    <h3 class="field-label">Lead Value</h3>
                                                    <p class="field-value">${{ number_format($lead->lead_value) }}</p>
                                                </div>
                                                <div class="terms-section">
                                                    <h3 class="field-label">Source</h3>
                                                    <p class="field-value">{{ $source_name }}</p>
                                                </div>
                                                <div class="terms-section">
                                ...
                                <div class="tab-pane fade " id="note-tab" role="tabpanel" aria-labelledby="note-tab-tab"
                                    tabindex="0">
                                    <div class="col-10">
                                        <form action="{{ url('add-lead-note/' . $lead->id . '') }}" method="post"
                                ...
                                <div class="tab-pane fade" id="activity-tab" role="tabpanel"
                                    aria-labelledby="activity-tab-tab" tabindex="0">
                                    <form action="{{ url('add-lead-activity/' . $lead->id . '') }}" method="post"
                                        enctype="multipart/form-data" data-parsley-validate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-5 mb-3">
                                                <label for="firstNameinput"
                                                    class="form-label">{{ __('app.leads.title-control') }}</label>
                                                <input type="text" class="form-control" name="title"
                                                    value="{{ old('title') }}" required>
                                            </div>
                                            <div class="col-md-5 mb-3">
                                                <label for="firstNameinput"
                                                    class="form-label">{{ __('app.leads.type') }}</label>
                                            ...
                                            <div class="col-md-5 mb-3">
                                                <label for="firstNameinput"
                                                    class="form-label">{{ __('app.leads.from') }}</label>
                                                <input type="text" class="form-control dateTimePicker" name="from"
                                                    data-provider="flatpickr" data-date-format="m/d/y"
                                                    data-enable-time="" readonly="readonly" required>
                                            </div>
                                            <div class="col-md-5 mb-3">
                                                <label for="firstNameinput"
                                                    class="form-label">{{ __('app.leads.to') }}</label>
                                            ...
                                            <div class="col-md-5 mb-3">
                                                <label for="firstNameinput"
                                                    class="form-label">{{ __('app.leads.location') }}</label>
                                            ...
                                            <div class="col-md-10 mb-3">
                                                <label for="firstNameinput"
                                                    class="form-label">{{ __('app.leads.description') }}</label>
                                ...
                                <div class="tab-pane fade" id="quote-tab" role="tabpanel"
                                    aria-labelledby="quote-tab-tab" tabindex="0">
                                    <div class="col-10">
                                        <div class="card card-default">
                                            <div class="card-body">

                                                <a href="{{ url('create-lead-quote/' . $lead->id . '') }}"
                                                    target="_blank">
                                                    <button class="btn btn-primary create-quote-btn">
                                                        {{ __('app.leads.create-quote') }}
                                                    </button>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="action-buttons position-absolute d-flex gap-2">
                                ...
                                <button class="action-btn add-btn" aria-label="Edit project" type="button"
                                    ...
                                    <svg width="40" height="40" viewBox="0 0 26 26" fill="none"
                                        ...
                                        <path
                                            d="M12.7292 13.2708H9.75V12.7292H12.7292V9.75H13.2708V12.7292H16.25V13.2708H13.2708V16.25H12.7292V13.2708Z"
                                            fill="black" />
                                    </svg>
                                        ...
                                        <section class="menu-content">
                                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                                <li class="nav-item w-100" role="presentation">
                                                    <button class="nav-link active filter-button" id="default-tab-tab"
                                                        data-bs-toggle="pill" data-bs-target="#default-tab"
                                                        type="button" role="tab" aria-controls="default-tab"
                                                        aria-selected="false">
                                                ...
                                                <li class="nav-item w-100" role="presentation">
                                                    <button class="nav-link  filter-button" id="note-tab-tab"
                                                        data-bs-toggle="pill" data-bs-target="#note-tab" type="button"
                                                        role="tab" aria-controls="note-tab" aria-selected="true">
                                                        <div class="menu-item activity-item">
                                                            <div class="item-content">
                                                                <svg width="20" height="20" viewBox="0 0 13 13"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        d="M3.76904 11.1685C3.49404 11.1685 3.25871 11.0706 3.06304 10.875C2.86738 10.6793 2.76938 10.4438 2.76904 10.1685V2.16846C2.76904 1.89346 2.86704 1.65812 3.06304 1.46246C3.25904 1.26679 3.49438 1.16879 3.76904 1.16846H7.76904L10.769 4.16846V10.1685C10.769 10.4435 10.6712 10.679 10.4755 10.875C10.2799 11.071 10.0444 11.1688 9.76904 11.1685H3.76904ZM7.26904 4.66846V2.16846H3.76904V10.1685H9.76904V4.66846H7.26904Z"
                                                                        fill="#556476" />
                                                                </svg>
                                                        ...
                                                        <div class="menu-item email-item">
                                                            <div class="item-content">
                                                                <svg width="20" height="20" viewBox="0 0 13 13"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        d="M2.76904 3.80798L5.82304 6.11398L5.82404 6.11498C6.16304 6.36348 6.33254 6.48798 6.51854 6.53598C6.68284 6.5785 6.85525 6.5785 7.01954 6.53598C7.20554 6.48798 7.37554 6.36348 7.71554 6.11398C7.71554 6.11398 9.67404 4.61098 10.769 3.80798M2.26904 8.70798V4.90798C2.26904 4.34798 2.26904 4.06798 2.37804 3.85398C2.47404 3.66548 2.62654 3.51298 2.81504 3.41698C3.02904 3.30798 3.30904 3.30798 3.86904 3.30798H9.66904C10.229 3.30798 10.509 3.30798 10.7225 3.41698C10.911 3.51298 11.064 3.66548 11.16 3.85398C11.269 4.06748 11.269 4.34748 11.269 4.90648V8.70998C11.269 9.26898 11.269 9.54798 11.16 9.76198C11.064 9.95021 10.9109 10.1032 10.7225 10.199C10.509 10.308 10.2295 10.308 9.67054 10.308H3.86754C3.30854 10.308 3.02854 10.308 2.81504 10.199C2.62689 10.1031 2.47391 9.95014 2.37804 9.76198C2.26904 9.54798 2.26904 9.26798 2.26904 8.70798Z"
                                                                        stroke="#556476" stroke-width="0.772298"
                                                                        stroke-linecap="round" stroke-linejoin="round" />
                                                                </svg>
                                                        ...
                                                        <div class="menu-item quote-item">
                                                            <div class="item-content">
                                                                <svg width="22" height="22" viewBox="0 0 15 15"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        d="M8.5414 5.36849L6.30782 7.55832C6.09548 7.76832 5.97882 8.05532 5.98348 8.35691C5.98985 8.662 6.11549 8.95245 6.33348 9.16599C6.55223 9.38241 6.84682 9.50666 7.1519 9.51191C7.30125 9.51505 7.44972 9.48828 7.58857 9.43319C7.72742 9.37809 7.85384 9.29577 7.9604 9.19107L10.1934 7.00124C10.4041 6.79284 10.5702 6.5438 10.6817 6.26925C10.7932 5.9947 10.8478 5.70035 10.8421 5.40407C10.8298 4.79386 10.5789 4.21274 10.1432 3.78533C9.70634 3.35299 9.11977 3.10545 8.50523 3.09408C8.20685 3.08812 7.91028 3.14169 7.63284 3.25167C7.3554 3.36164 7.10267 3.52581 6.8894 3.73458L4.65465 5.92499C4.3389 6.23775 4.0899 6.61134 3.92276 7.02315C3.75561 7.43495 3.67378 7.87639 3.68223 8.32074C3.70102 9.23584 4.07753 10.1072 4.73107 10.748C5.38607 11.3963 6.26546 11.7677 7.1869 11.7852C7.63465 11.7945 8.07975 11.7144 8.49614 11.5495C8.91253 11.3846 9.29183 11.1383 9.61182 10.825L11.8454 8.63399"
                    ...
                    <div class="card card-default mb-4 position-relative">
                                                    ...
                                                    <div class="card-body d-flex mb-3 position-relative mt-4 ">
                                                        ...
                                                        <div class="col-12 col-md-3 col-lg-4">
                                                            <section class="secondary-info">
                                                                ...
                                                                <div class="start-date-section">
                                                                    <h3 class="field-label">Description</h3>
                                                                    <p class="field-value">{{ $activity->description }}
                                                                    </p>
                                                                </div>
                                                            </section>
                        ...
                        <div class="action-buttons position-absolute d-flex gap-2">
                            <button class="action-btn edit-btn" aria-label="Edit project" type="button"
                                id="ActivityfilterButton" data-bs-toggle="collapse"
                            ...
                            <div class="create-menu-container collapse" id="collapseWidthExample2">
                                <nav class="create-menu">
                                    ...
                                    <section class="menu-content">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link active filter-button" id="events-all-tab"
                                                    data-bs-toggle="pill" data-bs-target="#events-all" type="button"
                                                    ...
                                                    <div class="menu-item activity-item">
                                                        <div class="item-content">
                                                            <svg width="18" height="18" viewBox="0 0 13 13"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                                    d="M5.26919 3.41277H10.7692M2.66919 3.31277L3.06919 3.71277L4.06919 2.71277M2.66919 6.31277L3.06919 6.71277L4.06919 5.71277M2.66919 9.31277L3.06919 9.71277L4.06919 8.71277M5.26919 6.41277H10.7692M5.26919 9.41277H10.7692"
                                                                    stroke="#4A58EC" stroke-width="0.603943"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="events-meetings-tab"
                                                    data-bs-toggle="pill" data-bs-target="#events-meetings"
                                                    type="button" role="tab" aria-controls="meetings"
                                                    aria-selected="false">
                                                    <div class="menu-item activity-item">
                                                        <div class="item-content">
                                                            <svg width="18" height="18" viewBox="0 0 13 13"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Provide a Reason for Winning</h5>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="firstNameinput" class="form-label">Won Value</label>
                        <input type="number" step="any" class="form-control" name="won_value" id="won_value"
                            required>
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="submitWonReason">Submit</button>
                </div>
            </div>
        </div>
    </div>

    <!-- Reason Popup Modal for Lost -->
    <div id="lostModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Provide a Reason for Losing</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="firstNameinput" class="form-label">Lost Reason</label>
                        <textarea id="lostReasonText" class="form-control" placeholder="Enter reason..."></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="firstNameinput" class="form-label">Closed Date</label>
                        <input type="date" class="form-control" name="lost_closed_date" id="lost_closed_date"
                            required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" id="submitLostReason">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            let selectedLeadId = $(select).data('lead-id');
            ...
            function updateUI() {
                ...
                wrapper.classList.remove('blue', 'orange', 'green', 'red');
                if (selectedClass) {
                    wrapper.classList.add(selectedClass);
                }

                // Open modals for won/lost or update immediately
                const selectedText = selectedOption.textContent.trim().toLowerCase();
                if (selectedText === 'won') {
                    $('#wonModal').modal('show');
                } else if (selectedText === 'lost') {
                    $('#lostModal').modal('show');
                } else {
                    // For New, Pending, etc.
                    updateLeadStage(selectedStageId, selectedLeadId, null, null, null);
                }
            }
            ...
            $('#submitLostReason').click(function() {
                const lost_closed_date = $('#lost_closed_date').val();
                const reason = $('#lostReasonText').val().trim();
                if (!lost_closed_date || !reason) {
                    alert('Please provide all required fields for lost stage.');
                    return;
                }
            ...
            function updateLeadStage(stageId, leadId, won_value, closed_date, reason) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        alert('Unauthorized to do this action.');
                    }
                });
            }
        });
        ...
        document.addEventListener("click", function(event) {
            ...
            const toggleButton = document.querySelector("[data-bs-target='#collapseWidthExample']");

            // Initialize or get the Bootstrap Collapse instance
            const bsCollapse = bootstrap.Collapse.getInstance(collapseElement) ||
                new bootstrap.Collapse(collapseElement, {
                    toggle: false
                });

            // Check if click is outside both the collapse and the button
            if (!collapseElement.contains(event.target) && !toggleButton.contains(event.target)) {
        ...
        document.addEventListener('click', function(event) {
            const collapseEl = document.getElementById('collapseWidthExample2');
            const buttonEl = document.getElementById('ActivityfilterButton');

            // check if collapse is open
            const isExpanded = collapseEl.classList.contains('show');

            if (isExpanded) {
                // check if click is outside collapse and button
                if (!collapseEl.contains(event.target) && !buttonEl.contains(event.target)) {
...
<div class="modal fade" id="wonModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content p-3">
            <div class="modal-header">
                <h5 class="modal-title">Won Stage</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                You selected "Won" stage.
            </div>
        </div>
    </div>
</div> --}}
