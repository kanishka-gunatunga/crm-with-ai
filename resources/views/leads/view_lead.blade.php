...
@section('content')
                                ...
                                <span>
                                    <svg width="18" height="19" viewBox="0 0 18 19" fill="none"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M8.99281 11.8847L13.1944 7.6842L12.4236 6.91235L8.99281 10.3431L5.56311 6.91235L4.79126 7.6842L8.99281 11.8847Z"
                                            fill="#4A58EC" />
                                    </svg>
                                </span>
                            </button> --}}
                        <div class="shading-button">
                            <div class="btn green lead-status-dropdown" id="statusWrapper">
                                <select class="form-select dropdown styled-select" id="leadStatusSelect"
                                    ...
                                    <option value="lost" data-color="#ED2227" data-class="red">Lost</option>
                                </select>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 mb-3">
                                            ...
                                            <input type="text" class="form-control flatpickr-input" name="from"
                                                data-provider="flatpickr" data-date-format="m/d/y" data-enable-time=""
                                    ...
                                    <section class="menu-content">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="default-tab-tab"
                                                    data-bs-toggle="pill" data-bs-target="#default-tab" type="button"
                                                    role="tab" aria-controls="default-tab" aria-selected="false">
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link active filter-button" id="note-tab-tab"
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="activity-tab-tab"
                                                    data-bs-toggle="pill" data-bs-target="#activity-tab" type="button"
                                                    role="tab" aria-controls="activity-tab" aria-selected="false">
                                                    <div class="menu-item activity-item">
                                                        <div class="item-content">
                    ...
                    <div class="card-body col-12">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="note-tab" role="tabpanel"
                                aria-labelledby="note-tab-tab" tabindex="0">
                                <div class="col-12">
                                    <h5 class="section-title">
                                        Notes
                                    </h5>
                            ...
                            <div class="create-menu-container collapse" id="collapseWidthExample2">
                                <nav class="create-menu">
                                    ...
                                    <section class="menu-content">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link active filter-button" id="all-tab"
                                                    data-bs-toggle="pill" data-bs-target="#all" type="button"
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="note2-tab"
                                                    data-bs-toggle="pill" data-bs-target="#note2" type="button"
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="calls-tab"
                                                    data-bs-toggle="pill" data-bs-target="#calls" type="button"
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="meetings-tab"
                                                    data-bs-toggle="pill" data-bs-target="#meetings" type="button"
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="lunches-tab"
                                                    data-bs-toggle="pill" data-bs-target="#lunches" type="button"
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="email2-tab"
                                                    data-bs-toggle="pill" data-bs-target="#email2" type="button"
                                                    role="tab" aria-controls="email2" aria-selected="false">
                                                    <div class="menu-item email-item">
                                                        <div class="item-content">
                                                            <svg width="20" height="20" viewBox="0 0 13 13"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="file2-tab"
                                                    data-bs-toggle="pill" data-bs-target="#file2" type="button"
                                            ...
                                            <li class="nav-item w-100" role="presentation">
                                                <button class="nav-link filter-button" id="quote2-tab"
                                                    data-bs-toggle="pill" data-bs-target="#quote2" type="button"
    ...
    <script>
        ...
        function updateUI() {
            ...
            // Update parent div background class
