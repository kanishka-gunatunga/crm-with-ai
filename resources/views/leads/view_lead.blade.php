                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-4 mb-3 cc-input d-none">
                                                    ...
                                                    <input type="text" data-choices data-choices-limit="Required Limit"
                                                        data-choices-removeItem class="form-control tagselect"
                                                        name="cc[]">
                                                </div>
                                ...
                                <div class="col-10">
                                    <div class="card card-default">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ url('create-lead-quote/' . $lead->id . '') }}" target="_blank">
                                    ...
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item w-100" role="presentation">
                                            <button class="nav-link filter-button" id="events-meetings-tab"
                                                data-bs-toggle="pill" data-bs-target="#events-meetings" type="button"
                                        ...
                                        <li class="nav-item w-100" role="presentation">
                                            <button class="nav-link filter-button" id="events-email-tab"
                                                data-bs-toggle="pill" data-bs-target="#events-email" type="button"
