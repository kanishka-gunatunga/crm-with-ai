                                ...
                                <div class="row g-4">
                                    <div class="col-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="field1"
                                            placeholder="Change your T&C from here" value="{{ $config->terms ?? '' }}"
                                            name="terms">
                                    </div>
                                    <div class="col-12 col-md-4">
                                            ...
                                            <div>
                                                ...
                                                <form action="" method="get" enctype="multipart/form-data">
                                                    ...
                                                    <div class="d-flex justify-content-center gap-3 align-items-center">
                                                        ...
                                                        <a href="{{ url('quotes') }}" class="btn clear-all-btn">Clear</a>
                                                    </div>
                            ...
                            <div class="row g-4">
                                <form id="bulk-delete-form" method="POST" action="{{ url('delete-selected-quotes') }}">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table new-table data-table-export" data-export-title="Quotes"
                                            data-export-filename="Quotes">
            ...
            <form action="" method="get" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="expire_start_date"
                            value="{{ request('expire_start_date') }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="expire_end_date" class="form-label">Expire End</label>
                        <input type="date" class="form-control" name="expire_end_date"
                            value="{{ request('expire_end_date') }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="created_start_date" class="form-label">Create Start</label>
                        <input type="date" class="form-control" name="created_start_date"
                            value="{{ request('created_start_date') }}">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="created_end_date" class="form-label">Create End</label>
                        <input type="date" class="form-control" name="created_end_date"
                            value="{{ request('created_end_date') }}">
                    </div>
                </div>
