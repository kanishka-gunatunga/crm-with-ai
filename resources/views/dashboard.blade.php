                        ...
                        <div class="col-md-2 mb-4 dashboard-top-col">
                            <div class="card card-default dashbboard-card">
                                <div class="card-body pb-0">
                                    <div class="row ">
                                        <div class="col-md-9">
                                            <p class="stat-card-title">CUSTOMERS (PERSONS)</p>
                        ...
                        <div class="col-md-2 mb-4 dashboard-top-col">
                            <div class="card card-default dashbboard-card">
                                <div class="card-body pb-0">
                                    <div class="row ">
                                        <div class="col-md-9">
                                            <p class="stat-card-title">ORGANIZATIONS</p>
                                            <h5 class="stat-card-value">{{ number_format(count($all_organizations)) }}</h5>
                                        </div>
                                        <div class="col-md-3 d-flex justify-content-end">
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="card-footer bg-white">
                                    <span class="badge rounded-pill stat-badge-success">
                                        ...
                                        +{{ number_format(count($this_month_organizations)) }}
                        ...
                        <div class="col-md-2 mb-4 dashboard-top-col">
                            <div class="card card-default dashbboard-card">
                                <div class="card-body pb-0">
                                    <div class="row ">
                                        <div class="col-md-9">
                                            <p class="stat-card-title">QUOTATIONS</p>
                                            <h5 class="stat-card-value">{{ number_format(count($all_quotations)) }}</h5>
                                        </div>
                                        <div class="col-md-3 d-flex justify-content-end">
                                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                                xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="card-footer bg-white">
                                    <span class="badge rounded-pill stat-badge-success">
                                        ...
                                        +{{ number_format(count($this_month_quotations)) }}
                                                ...
                                                <ul class="nav nav-pills d-flex justify-content-around justify-content-md-start"
                                                    ...
                                                    <li class="nav-item flex-grow-1 flex-md-grow-0 text-center"
                                                        ...
                                                        <button class="nav-link w-100 w-md-auto"
                                                            id="pills-monthly-tab-mobile" data-bs-toggle="pill"
                                                    ...
                                                    <li class="nav-item flex-grow-1 flex-md-grow-0 text-center"
                                                        role="presentation">
                                                        <button class="nav-link w-100 w-md-auto"
                                                            id="pills-yearly-tab-mobile" data-bs-toggle="pill"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <h2 class="dashboard-card-heder">My Activities</h2>
                                            </div>
                                        </div>
                                        <div class="table-responsive my-leads-table">
                                            <table id="buttons-datatables" class="display table new-table bordered-table"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="corner-left">Title</th>
                                                        <th>Type</th>
                                                        <th>From</th>
                                                        <th class="corner-right">To</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($my_activities as $my_activity)
                                                        <tr>
                                                            <td>{{ $my_activity->title }}</td>
                                                            <td>{{ $my_activity->type }}</td>
                                                            <td>{{ Carbon::parse($my_activity->from)->format('F j, Y h:i A') }}
                                                            </td>
                                                            <td>{{ Carbon::parse($my_activity->to)->format('F j, Y h:i A') }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                ...
                                                <h2 class="dashboard-card-heder">Recent Quotations</h2>
                                            </div>
                                            ...
                                            <table id="buttons-datatables" class="display table new-table bordered-table"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Subject</th>
                                                        <th>Expired at</th>
                                                        <th class="corner-right">Person</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($recent_quotations as $recent_quotation)
                                                        <tr>
                                                            <td>{{ $recent_quotation->id }}</td>
                                                            <td>{{ $recent_quotation->leadData->title ?? '' }}</td>
                                                            <td>{{ $recent_quotation->subject ?? '' }}</td>
                                                            <td>{{ Carbon::parse($recent_quotation->expired_at)->format('F j, Y h:i A') }}
                                                            </td>
                                                            <td>{{ $recent_quotation->personData->name ?? '' }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
                                ...
                                <div class="card card-default leadsOverview">
                                    <div
                                        ...
                                        <div
                                            class="d-md-none d-flex flex-column flex-md-row justify-content-md-between align-items-md-center w-100">
                                            <div>
                                                <h2 class="dashboard-card-heder text-center text-md-start mb-3 mb-md-0">
                                                    Lead
                                                    Status</h2>
                                            </div>
                                            <div
                                                ...
                                                <div class="text-center text-md-start">
                                                    ...
                                                    <span class="badge rounded-pill stat-badge-success">
                                                        <svg width="10" height="6" viewBox="0 0 10 6"
                                                            ...
                                                            <path
                                                                d="M9 1L6.5 3.5C6.0585 3.9415 5.838 4.162 5.5675 4.1865C5.5225 4.1905 5.4775 4.1905 5.4325 4.1865C5.162 4.1615 4.9415 3.9415 4.5 3.5C4.0585 3.0585 3.838 2.838 3.5675 2.8135C3.52259 2.80944 3.47741 2.80944 3.4325 2.8135C3.162 2.8385 2.9415 3.0585 2.5 3.5L1 5"
                                                                stroke="#00C500" stroke-width="0.75"
                                                                stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                        +15
                                                    </span>
                                        ...
                                        <div class="d-none d-md-flex justify-content-between w-100">
                                            ...
                                            <div class="d-flex gap-5">
                                                ...
                                                <div class="time-duration-buttons dashboard-tabs">
                                                    <ul class="nav nav-pills" id="pills-tab-desktop-status"
                                                        role="tablist">
                                                        <li class="nav-item" role="presentation">
                                    ...
                                    <div>
                                        <div class="tab-content" id="pills-tabContent">
                                            <div class="tab-pane fade show active" id="pills-weekly-status"
                                                role="tabpanel" aria-labelledby="pills-weekly-status-tab">
                                ...
                                <div class="calendar-container">
                                    ...
                                    @if (in_array(strtolower('show-own-activities'), array_map('strtolower', $permissions)))
                                        <div class="events-section mt-4">
                                            <h2 class="dashboard-upcomming-evenet-text">Upcoming Events</h2>
