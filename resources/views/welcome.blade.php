...
<body style="background-color: #F6F6F8 !important; position: relative;">
        ...
        <div class="login-card card card-default">
            ...
            <form class="login-form" method="POST" action="">
                ...
                <div class="form-fields">
                    ...
                    <div class="mb-3">
                        <input type="email"
                            class="input-field email-field form-control @error('email') is-invalid @enderror"
                            placeholder="{{ __('app.sessions.login.email') }}"
                            name="email"
                            id="username"
                            value="{{ old('email') }}"
                            required>
                    ...
                    <!-- <div class=" mb-3"> -->
                        <!-- <div class="position-relative  auth-pass-inputgroup"> -->
                            <input type="password"
                                class="password-input password-field form-control pe-5 password-input @error('password') is-invalid @enderror"
                                placeholder="{{ __('app.sessions.login.password') }}"
                                name="password"
                                id="password-input"
                                required>
                    ...
                    <div class="mb-3">
                        <a href="{{ url('forgot-password') }}" class="forgot-link">{{ __('app.sessions.login.forgot-password') }}</a>
                    </div>
                </div>

                <div>
                    <button type="submit" class="login-btn w-100 btn btn-info">{{ __('app.sessions.login.login') }}</button>
                </div>
            ...
            <footer class="copyright-text">
                <span>Copyright © {{ date('Y') }} {{ $config->company_name ?? 'ClientIQ' }}</span><span>.</span><span> All Rights Reserved.</span>
            </footer>
        </div>
    </main>
    ...
    <div class="position-absolute top-0" style="right: -20px; z-index: -1;">
        <svg width="439" height="181" viewBox="0 0 439 181" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M182.979 -93.842C196.698 -108.343 216.782 -117.712 238.718 -117.712C267.225 -117.712 292.742 -101.209 306.173 -77.3385C317.751 -82.8397 330.894 -85.6246 344.612 -85.6246C396.771 -85.6246 438.997 -42.8224 438.997 9.91205C438.997 62.5779 396.702 105.366 344.324 105.366C338.041 105.366 331.744 104.584 325.681 103.432C313.896 124.874 291.384 139.155 265.305 139.155C254.303 139.155 244.151 136.371 235.151 132.296C223.079 160.515 195.065 180.243 162.415 180.243C128.406 180.243 99.323 158.883 88.3206 128.729C83.3956 129.799 78.4569 130.087 73.2438 130.087C32.9385 130.087 0 97.1489 0 55.993C0 28.5557 14.7887 4.68526 36.7248 -8.16911C32.0742 -18.5953 29.5774 -30.1738 29.5774 -41.9718C29.5774 -89.1365 68.017 -127 114.674 -127C142.688 -127 166.764 -114.132 182.691 -94.0615L182.979 -93.842Z" fill="#D5D8FB" />
        </svg>
    </div>
